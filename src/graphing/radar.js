...
const Radar = function (size, radar) {
  ...
  function plotRadarFooter() {
    d3.select('body')
      ...
      .append('p')
      .html('<center><a href="https://developer.vantiv.com"> VantivONE</a>')
      .append('p')
      .html('The TechVitality information and materials provided herein by Vantiv (the “TechVitality Materials”) are provided to you for information purposes only on an “AS IS” basis with no representations or warranties expressed or implied, including, but not limited to, warranties of suitability, quality, merchantability, or fitness for a particular purpose (irrespective of any course of dealing, custom or usage of trade), and all such warranties are expressly and specifically disclaimed.  Vantiv shall have no liability or responsibility to you or any other person or entity with respect to any liability, loss, or damage, including lost profits whether foreseeable or not, or other obligation for any cause whatsoever, caused or alleged to be caused directly or indirectly by your use of the TechVitality Materials. Use of the TechVitality Materials signifies agreement with the disclaimer set forth in this paragraph.  Ownership of all TechVitality Materials and all intellectual property rights therein and thereto shall remain at all times with Vantiv.');
  }
